...
############################################### 
import logging 
logging.basicConfig(filename='etl_predictions_api.log', 
...
logger.info("II- Log setup: Success") 


###############################################
## III- API CALL: ALL MATCHES IN FUTURE 7 DAYS
############################################### 
...
logger.info("III- API CALL future matches: Success") 
